using Example.Tests.CoreExample.Components.Logger;
using Example.Tests.CoreExample.Components.Logger.Elements;
...
namespace Example.Tests.CoreExample.Components
{
    ...
    public class LoggerHelper : SystemComponentMulti<LoggerElement, LoggerElementType>
    {
        ...
        public static bool SendMessage(LoggerMessageType loggerType, string message)
        {
            return SendMessage(LoggerMessage.New(loggerType, message));
        }
        public static bool SendInformation(string text)
        {
        ...
        public static bool SendWarning(string text)
        {
